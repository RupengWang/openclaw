...
const DASHSCOPE_REGION_BASE_URL = {
  cn: "https://dashscope.aliyuncs.com/compatible-mode/v1",
  intl: "https://dashscope-intl.aliyuncs.com/compatible-mode/v1",
  us: "https://dashscope-us.aliyuncs.com/compatible-mode/v1"
} as const;

const DASHSCOPE_BASE_URL = DASHSCOPE_REGION_BASE_URL.cn;
const DASHSCOPE_DEFAULT_MODEL_ID = "qwen3-max";
const DASHSCOPE_DEFAULT_CONTEXT_WINDOW = 262144;
const DASHSCOPE_DEFAULT_MAX_TOKENS = 65536;
...
export async function resolveImplicitProviders(params: {
  ...
  if (dashscopeKey) {
    const dashscope = { ...buildDashscopeProvider(), apiKey: dashscopeKey };
  }
