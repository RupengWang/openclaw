...
export function buildDashscopeApiModelDefinition(modelId: string): ModelDefinitionConfig {
  const base = buildDashscopeModelDefinition();
  if (modelId === DASHSCOPE_DEFAULT_MODEL_ID) {
    return base;
  }
  return {
    ...base,
