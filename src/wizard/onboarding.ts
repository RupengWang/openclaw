  ...
  if (authChoiceFromPrompt && authChoice !== "custom-api-key") {
    ...
    if (providerId === "dashscope") {
      const regionSelection = await prompter.select({
        ...
        options: [
          { value: "cn", label: "CN", hint: "https://dashscope.aliyuncs.com" },
          { value: "intl", label: "SG", hint: "https://dashscope-intl.aliyuncs.com" },
          { value: "us", label: "US(Virginia)", hint: "https://dashscope-us.aliyuncs.com" }
        ],
        initialValue: "cn"
      });

      const { applyDashscopeProviderConfigWithModelId } = await import(
        "../commands/onboard-auth/config-core.js"
      );
